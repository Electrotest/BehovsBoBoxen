...
$bbb->config['datetimezone'] = 'Europe/Stockholm';
...
$bbb->config['javascript']['jquery3'] = 'js/jquery-3.2.1.min.js';
$bbb->config['javascript']['jqueryui'] = 'js/jquery-ui.min.js';
...
$bbb->config['theme'] = array(
    ...
    'data' => array(
        ...
        'footer' => '<p class="bbbfooter">BehovsBoBoxen &copy; Anders Kjellström, <a href="http://www.behovsbo.se">www.behovsbo.se</a></p>',
    ),
);
