...
class CViewContainer {
    ...
    public function ChangeTemplate($value) {
        $Behovsboboxen->request->config['theme']['template_file'] = $value;
    }
    ...
    public function AddInclude($file, $variables = array(), $region = 'default') {
        ...
        //var_dump($this->views[$region]);
        return $this;
    }

    public function AddSome($templ, $file, $variables = array()) {
        $Behovsboboxen->request->config['theme']['template_file'] = $templ;
        $Behovsboboxen->request->config['theme']['menu_to_region'] = array();
        $Behovsboboxen->request->config['theme']['header'] = "";
        $Behovsboboxen->request->config['theme']['slogan'] = "";
        $Behovsboboxen->request->config['theme']['stylesheet'] = "";
        $Behovsboboxen->request->config['theme']['favicon'] = "";
        $Behovsboboxen->request->config['theme']['logo'] = "";
        $Behovsboboxen->request->config['theme']['footer'] = "";
//echo $Behovsboboxen->request->config['theme']['template_file'];
        $this->views['primary'][] = array('type' => 'json', 'file' => $file, 'variables' => $variables);
        //var_dump($this->views[$region]);
        return $this;        
    }
