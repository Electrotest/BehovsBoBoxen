 ...
 * @return string if jquery path is defined, else null.
 */
function jquery3_include() {
  global $bbb;
  return isset($bbb->config['javascript']['jquery3']) ? "<script src='" . static_url($bbb->config['javascript']['jquery3']) . "'></script>" : null;
}
...
function jquery_migrate(){
  global $bbb;
  return isset($bbb->config['javascript']['migrate']) ? "<script src='" . static_url($bbb->config['javascript']['migrate']) . "'></script>" : null;
}