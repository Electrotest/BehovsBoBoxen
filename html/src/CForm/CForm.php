...
class CFormElement implements ArrayAccess {
    ...
    public function GetHTML() {
        ...
        if ($this['type'] == 'submit') {
            ...
            return "<p><span class='layout'><label for='$id'>$label</label></span><input id='$id'{$type}{$class}{$name}{$size}{$value}{$autofocus}{$readonly} />{$messages}</p>";
        }
    }
...
//echo "Är array: " . $request[$element['name']];
      } else {
      $values[$element['name']]['value'] = $element['value'] = $request[$element['name']];
//echo "Inte array: " . $request[$element['name']];
      }

      // If the element is a checkbox, set its value of checked.
      if($element['type'] === 'checkbox') {
//echo "<br />Elementet är checkbox<br />";
      $element['checked'] = true;
      }

      if(isset($element['validation'])) {
//echo "<br />Vi vill validera<br />";
...
//var_dump($values[$element['name']]);
//echo "<br />Validerar inte<br />";
            $validates = false;
        }else{
//echo "<br />Validerar<br />";
        }
      }else{
        $validates = true;
//echo "<br />Vi vill inte validera<br />";
    }
