...
<?php else: ?>
    ...
    <table>
        ...
        <tbody>
            <tr><td>Part of Behovsboboxen Core modules</td><td><?= $module['isBehovsboboxenCore'] ? 'Yes' : 'No' ?></td></tr>
            <tr><td>Part of Behovsboboxen CMF modules</td><td><?= $module['isBehovsboboxenCMF'] ? 'Yes' : 'No' ?></td></tr>
