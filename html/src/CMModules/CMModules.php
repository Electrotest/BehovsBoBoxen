...
/**
 * A model for managing Behovsboboxen modules.
 *
...
class CMModules extends CObject {
     ...
     * Properties
     */
    private $behovsboboxenCoreModules = array('CBehovsboboxen', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
    private $behovsboboxenCMFModules = array('CForm', 'CFormElement', 'CFormElementText', 'CFormElementTextarea', 'CFormElementHidden', 'CFormElementPassword', 'CFormElementPasswordTwit', 'CFormElementSubmit', 'CFormElementButton', 'CCPage', 'CMUser', 'CCUser', 'CMTranslate','CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier', 'CTextFilter');
    ...
    public function ReadAndAnalyse() {
        $src = BEHOVSBOBOXEN_INSTALL_PATH . '/src';
        if (!$dir = dir($src))
    ...
    private function GetDetailsOfModule($module) {
        ...
        if (class_exists($module)) {
            ...
            $details['isBehovsboboxenCore'] = in_array($rc->name, $this->behovsboboxenCoreModules);
            $details['isBehovsboboxenCMF'] = in_array($rc->name, $this->behovsboboxenCMFModules);
