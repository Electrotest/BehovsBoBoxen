 ...
 * Set database(s).
 */
$bbb->config['database'][0]['dsn'] = 'sqlite:' . BEHOVSBOBOXEN_APPLICATION_PATH . '/data/.ht.sqlite';
//sqlite:/var/www/behovsboboxen/application/data/.ht.sqlite
//sqlite:C:\wamp\www\p\behovsboboxen/application/data/.ht.sqlite
