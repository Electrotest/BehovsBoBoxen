...
g_l = [];
g_l["MONTHS"] = ["Januari","Februari","Mars","April","Maj","Juni","Juli","Augusti","September","Oktober","November","December"];
g_l["DAYS_3"] = ["Sön","Mån","Tis","Ons","Tor","Fre","Lör"];
g_l["MONTH_FWD"] = "Gå framåt en månad";
g_l["MONTH_BCK"] = "Gå tillbaka en månad";
g_l["YEAR_FWD"] = "Gå framåt ett år";
g_l["YEAR_BCK"] = "Gå tillbaka ett år";
g_l["CLOSE"] = "Stäng kalendern";
g_l["ERROR_2"] = g_l["ERROR_1"] = "Felaktigt data objekt!";
g_l["ERROR_4"] = g_l["ERROR_3"] = "Felaktigt mål";
...
g_jsDatePickImagePath = "../themes/images/";
	...
	if (this.oConfiguration.useMode == 2){
		if (this.oConfiguration.target != false){
			if (typeof(JsgetElem(this.oConfiguration.target)) != null){
				...
				JsDatePickBox.style.top = "-30px";
				JsDatePickBox.style.left = "150px";
